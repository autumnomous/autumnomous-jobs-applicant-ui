    ...
    <div class="container">
      <div class="space-top-2 space-bottom-1 space-bottom-lg-2">
        <div class="row justify-content-lg-between">
              ...
              <li class="nav-item">
                <a class="nav-link media" href="tel:1-062-109-9222">
                  <span class="media">
                    ...
                    <span class="media-body"> +1 (062) 109-9222 </span>
                  </span>
                </a>
              </li>
            </ul>
          ...
          <div class="col-6 col-md-3 col-lg mb-5 mb-lg-0"></div>

          <div class="col-6 col-md-3 col-lg mb-5 mb-lg-0"></div>

          <div class="col-6 col-md-3 col-lg"></div>
      ...
      <div class="space-1">
        ...
        <div class="w-md-75 text-lg-center mx-lg-auto">
          <p class="text-white opacity-sm small">
            &copy; Front. 2020 Htmlstream. All rights reserved.
          </p>
          <p class="text-white opacity-sm small">
