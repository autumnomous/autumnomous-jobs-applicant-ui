<template>
    <the-card id="job-preferences">
        ...
        <template v-slot:cardbody>
          <alert-error v-if="submissionError" :message="errorMessage"></alert-error>
            ...
            <div class="form-group" >
              ...
              <input v-model="locationSearch" type="text" class="form-control mb-2" name="location" id="location" aria-label="Location"  placeholder="Search for a City" :class="{ 'is-invalid': v$.locationSearch.$error}">
              ...
              <p class="btn btn-sm btn-primary mt-2 mr-2" v-for="city of desiredCities" :key="city.id" @click="removeCity(city.text)">
                  {{city.text}} <span class="badge badge-pill badge-secondary">X</span>
              </p>
        ...
        <template v-slot:cardfooter>
                ...
                <div class="ml-auto">
                    <button type="button" class="btn btn-primary" id="step-2-button" @click.prevent="formSubmit">
      ...
      props:{
       ...
       setup(){
        ...
        methods:{
            ...
            removeCity(cityName){
              var index = this.desiredCities.findIndex(e => e.text == cityName)
         ...
         watch:{
            ...
            selectedCity: async function(newVal, oldVal){
                ...
                var index = this.desiredCities.findIndex(e => e.id == newVal )
