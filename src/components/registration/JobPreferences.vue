      ...
      <div class="form-group">
        ...
        <VueMultiselect v-model="state.desiredCities" :options="state.autocompleteLocations" :multiple="true" :searchable="true"
          ...
          <template v-slot:tag="props">
            <span class="multiselect__tag btn-primary">
              <span v-text="props.option.text"></span>
              <i tabindex="1" @keypress.enter.prevent="props.remove(option)" @mousedown.prevent="props.remove(option)"
